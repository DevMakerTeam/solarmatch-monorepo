...
const OrdersContractInstallList = () => {
  return (
    <div className="w-full mb-[30px] lg:mb-[60px] grid lg:grid-cols-4 grid-cols-1 gap-[20px]">
      {new Array(4).fill(0).map((_, index) => (
        <div
          className="shadow-[0px_0px_9px_2px_rgba(0,0,0,0.1)] hover:ring-2 hover:ring-border-color ring-offset-0 transition-shadow w-full rounded-[8px] flex lg:flex-col"
          key={`order-contract-install-list-${index}`}
        >
...
export default OrdersContractInstallList;
