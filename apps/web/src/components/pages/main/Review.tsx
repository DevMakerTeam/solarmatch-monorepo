...
const REVIEW_DATA = [
  ...
  },
  {
    ...
    content: [
      ...
      {
        text: '같은 용량이라도 가격 차이가 200만 원 이상 나더라고요. 지체 브랜드까지 비교해보고,',
        highlights: ['같은 용량이라도 가격 차이가 200만 원 이상'],
      },
      {
        text: '확실히 남들이 갔습니다. 괜히 발품 안 팔고 바로 여기서 비교하신 잘했어요."',
        highlights: [],
      },
    ],
  },
  {
    ...
    content: [
      {
        text: '"예전엔 시공사가 어떤 자재를 쓰는지도 제대로 물어볼 수 없는데, 여기서는 모듈·인버터',
        highlights: ['모듈·인버터'],
      },
      {
        text: '모델명까지 투명하게 공개해서 좋았습니다. 시공사끼리 경쟁 차이가 난 이유를',
        highlights: ['모델명까지 투명하게 공개'],
      },
      {
        text: '직접 확인할 수 있었고, 결과 가성비 좋은 선택을 할 수 있었어요.',
        highlights: [],
      },
      {
        text: '무엇보다 후기리뷰이 전혀 안 나는 게 제일 안심스럽습니다."',
        highlights: [],
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        text: '우리 가족이 납득할 수 있었어요.',
        highlights: [],
      },
      {
        text: '지금은 전기요금 절감 덕분에 아버지가 농사 일 하실 때 여가 생겼습니다."',
        highlights: [],
      },
    ],
  },
